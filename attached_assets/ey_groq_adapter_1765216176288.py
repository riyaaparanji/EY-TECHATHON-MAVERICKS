# backend/ey_groq_adapter.py
# Safe adapter version (demo). Replace ask_llm with your real LLM call when available.
...
def ask_llm(system_prompt: str, user_input: str) -> str:
    # Simple mock: return JSON containing query and maybe max_price
